...
export enum EnumDBStatements {
  ...
  InsEntitiesFalsch = "INSERT INTO Entities (ENTI_NAME, ENTI_CATEGORY_ID, ENTI_LOCKED, ENTI_CREATED_AT, ENTI_LAST_EDITED_AT, ENTI_LAST_EDITED_BY, ENTI_NOTES, ENTI_DB_ID) VALUES ('?', ?, 0, NULL, NULL, NULL, '?', ?)",
  InsEntities = "INSERT INTO Entities (ENTI_NAME, ENTI_CATEGORY_ID, ENTI_LOCKED, ENTI_CREATED_AT, ENTI_LAST_EDITED_AT, ENTI_LAST_EDITED_BY, ENTI_NOTES, ENTI_DB_ID) VALUES (?, ?, 0, datetime(), datetime(), NULL, ?, ?)",
  ...
  SelEntriesWithDbID = "SELECT ENTI_ID, ENTI_NAME, ENTI_CATEGORY_ID, ENTI_LOCKED, ENTI_CREATED_AT, ENTI_LAST_EDITED_AT, ENTI_LAST_EDITED_BY, ENTI_NOTES, ENTI_DB_ID FROM Entities where ENTI_DB_ID = ?",
